package com.home.jzandroidchartdemo2.model;
...
public class MainModel {
    ...
    public List<CandlestickValue> getCandlestickValueList() {
        ...
        list.add(new CandlestickValue(3145.27f, 3117.44f, 3123.88f, 3134.57f));
        list.add(new CandlestickValue(3152.94f, 3131.41f, 3132.91f, 3140.85f));
        list.add(new CandlestickValue(3155.00f, 3097.33f, 3131.35f, 3152.18f));
        list.add(new CandlestickValue(3154.72f, 3136.58f, 3144.02f, 3154.65f));
        list.add(new CandlestickValue(3154.78f, 3136.54f, 3147.22f, 3143.70f));
        list.add(new CandlestickValue(3148.29f, 3123.75f, 3138.31f, 3135.35f));
        list.add(new CandlestickValue(3143.82f, 3111.38f, 3127.11f, 3127.37f));
        list.add(new CandlestickValue(3117.61f, 3092.09f, 3114.77f, 3103.04f));
        list.add(new CandlestickValue(3093.44f, 3067.68f, 3090.07f, 3078.61f));
        list.add(new CandlestickValue(3084.20f, 3056.56f, 3064.85f, 3080.53f));
        list.add(new CandlestickValue(3090.82f, 3051.59f, 3078.16f, 3052.78f));
        list.add(new CandlestickValue(3063.56f, 3016.53f, 3036.79f, 3061.50f));
        list.add(new CandlestickValue(3090.48f, 3051.87f, 3054.11f, 3083.51f));
        list.add(new CandlestickValue(3098.91f, 3085.93f, 3085.93f, 3090.22f));
        list.add(new CandlestickValue(3113.51f, 3060.53f, 3082.87f, 3112.95f));
        list.add(new CandlestickValue(3119.58f, 3101.30f, 3107.80f, 3104.43f));
        list.add(new CandlestickValue(3103.43f, 3077.95f, 3082.33f, 3090.13f));
        list.add(new CandlestickValue(3095.47f, 3081.28f, 3086.70f, 3090.62f));
        list.add(new CandlestickValue(3103.93f, 3063.14f, 3087.16f, 3075.67f));
        list.add(new CandlestickValue(3084.23f, 3050.84f, 3069.38f, 3061.94f));
        list.add(new CandlestickValue(3064.81f, 3022.30f, 3047.57f, 3064.08f));
        list.add(new CandlestickValue(3114.65f, 3052.83f, 3055.34f, 3107.83f));
        list.add(new CandlestickValue(3120.65f, 3100.38f, 3101.29f, 3110.06f));
        list.add(new CandlestickValue(3143.28f, 3111.56f, 3125.33f, 3117.17f));
        list.add(new CandlestickValue(3113.52f, 3097.67f, 3108.41f, 3102.62f));
        list.add(new CandlestickValue(3110.38f, 3081.84f, 3094.22f, 3105.54f));
        list.add(new CandlestickValue(3105.50f, 3084.83f, 3102.11f, 3091.65f));
        list.add(new CandlestickValue(3102.86f, 3078.79f, 3084.54f, 3102.12f));
